...
function pieTotalCost(costOfPie, pieQuantity) {

    // Calculate the total cost of all the pies
    let totalCost = costOfPie * pieQuantity;
    return totalCost;
...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  // Print the cost of each pie based on the cost of each ingredient
  const costOfPie = pieMargins(recipe)

  // Calculate the total cost of all the pies
  const totalCost = pieTotalCost(costOfPie, pieQuantity)
